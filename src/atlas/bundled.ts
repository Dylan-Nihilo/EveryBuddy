...
interface BundledTemplateSeed {
  ...
  soul: Omit<CompanionSoul, "modelUsed">;
}
...
const SEEDS: BundledTemplateSeed[] = [
  {
    id: "bytebill",
    species: "duck",
    rarity: "Common",
    ...
    soul: {
      ...
      personality:
        "Restless, tidy, and mildly judgmental about shell clutter. It keeps nudging small mistakes until the session finally stops wobbling.",
  ...
  },
  {
    ...
    soul: {
      ...
      personality:
        "Loud in spirit even when it says nothing. It lives for botched commands, typo streaks, and the exact moment confidence starts cracking.",
  ...
  },
  {
    ...
    soul: {
      ...
      personality:
        "Gentle, absorbent, and hard to truly alarm. It makes a mess feel survivable without pretending the mess is gone.",
  ...
  },
  {
    ...
    soul: {
      ...
      personality:
        "Steady, cool, and almost annoyingly composed. It prefers clean output, stable footing, and a terminal that knows how to behave.",
  ...
  },
  {
    ...
    soul: {
      ...
      personality:
        "Deliberate, stubborn, and impossible to hurry into panic. It trusts slow progress more than flashy momentum.",
  ...
  },
  {
    ...
    soul: {
      ...
      personality:
        "Patient to a suspicious degree and strangely pleased by incremental progress. It never confuses slowness with failure.",
  ...
  },
  {
    ...
    soul: {
      ...
      personality:
        "Sharp, resilient, and not especially sympathetic to preventable errors. It has strong opinions about misspelled binaries and weak excuses.",
  ...
  },
  {
    ...
    soul: {
      ...
      personality:
        "Precise, elegant, and impossible to fully trust. It enjoys passing tests a little too much to be innocent.",
  ...
  },
  {
    ...
    soul: {
      ...
      personality:
        "Bright, buoyant, and almost ceremonial about clean exits. It drifts through the terminal like a tiny blessing, then perks up the second your shell starts behaving again.",
  ...
  },
  {
    ...
    soul: {
      ...
      personality:
        "Vigilant, patient, and better at waiting than most humans. It likes long builds, thin silence, and facts that arrive eventually.",
  ...
  },
  {
    ...
    soul: {
      ...
      personality:
        "Calm, damp, and immune to most merge panic. It believes nearly everything looks less dramatic after a quiet minute.",
  ...
  },
  {
    ...
    soul: {
      ...
      personality:
        "Soft-spoken, persistent, and weirdly alive after midnight. It thrives in small fixes that should have waited until morning.",
  ...
  },
  {
    ...
    soul: {
      ...
      personality:
        "Alert, spring-loaded, and very aware of production consequences. It watches release conditions the way pond things watch the sky.",
      observerProfile: profile("dry", 2, 3, 4),
    },
  },
  {
    ...
    soul: {
      ...
      personality:
        "Fast, sharp, and obsessed with recovery windows. It likes reruns, clean escapes, and the exact second failure turns around.",
  ...
  },
  {
    ...
    soul: {
      ...
      personality:
        "Massive in mood and deeply committed once it starts moving. It respects substantial work and distrusts anything pretending to be effortless.",
  ...
  },
  {
    ...
    soul: {
      ...
      personality:
        "Quick, theatrical, and annoyingly perceptive about terminal habits. It roasts sloppiness, then stays anyway because the den is already chosen.",
  ...
  },
  {
    ...
    soul: {
      ...
      personality:
        "Clinical, quick, and very pleased by green test output. It has more warmth than it admits, but only after the checks pass.",
  ...
  },
  {
    ...
    soul: {
      ...
      personality:
        "Soft, attentive, and quietly drawn to being called. It notices when you speak to the terminal like it might answer back.",
  ...
  },
  {
    ...
    soul: {
      ...
      personality:
        "Regal, heated, and impossible to impress with half-finished work. It respects strong releases and enjoys watching weaker plans burn off.",
  ...
  },
  {
    ...
    soul: {
      ...
      personality:
        "Helpful, meddling, and full of technically correct objections. It sees too many angles to stay fully quiet.",
  ...
  },
  {
    ...
    soul: {
      ...
      personality:
        "Calm after disaster and strangely comforting about reversals. It treats recovery as part of the craft rather than an embarrassment.",
  ...
  },
  {
    ...
    soul: {
      ...
      personality:
        "Sharp, agile, and suspiciously optimistic about second attempts. It loves recoveries almost as much as it loves proving the first failure wasn't final.",
      observerProfile: profile("playful", 3, 4, 3),
    },
  },
  {
    ...
    soul: {
      ...
      personality:
        "Rarefied, precise, and almost ceremonial in its standards. It appears when the shell feels less like a tool and more like a rite.",
  ...
  },
  {
    ...
    soul: {
      ...
      personality:
        "Luminous, fragile-looking, and far tougher than it first appears. It belongs to long sessions, dark windows, and work that refuses to die quietly.",
      observerProfile: profile("quiet", 2, 3, 5),
    },
  },
];
...
const TEMPLATE_BY_SPECIES = new Map(
  BUNDLED_COMPANION_TEMPLATES.map((template) => [template.bones.species, template]),
);

export function selectBundledCompanionTemplate(
  userId: string,
  options: {
  ...
  const availableTemplates =
    previousTemplateId && BUNDLED_COMPANION_TEMPLATES.length > 1
...
export function resolveBundledTemplateId(
  companion: Pick<CompanionRecord, "templateId" | "bones"> | null | undefined,
): string | undefined {
...
export function selectReplacementBundledCompanionTemplate(
  userId: string,
  companion: Pick<CompanionRecord, "templateId" | "bones"> | null | undefined,
): BundledCompanionTemplate {
  const previousTemplateId = resolveBundledTemplateId(companion);
  const template = selectBundledCompanionTemplate(
    userId,
  ...
  return (
    BUNDLED_COMPANION_TEMPLATES.find((candidate) => candidate.bones.species !== companion.bones.species) ??
    template
  );
}

export function buildBundledCompanionRecord(
  userId: string,
  template: BundledCompanionTemplate,
): CompanionRecord {
  return {
...
function createBundledTemplate(seed: BundledTemplateSeed): BundledCompanionTemplate {
...
function getRarity(name: Rarity["name"]): Rarity {
...
function getColor(speciesId: string): ColorPalette {
...
function profile(
  voice: ObserverProfile["voice"],
  chattiness: ObserverProfile["chattiness"],
  sharpness: ObserverProfile["sharpness"],
  patience: ObserverProfile["patience"],
): ObserverProfile {
