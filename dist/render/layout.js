...
export function padDisplayWidth(value, width) {
    const padding = Math.max(0, width - visibleLength(value));
    return `${value}${" ".repeat(padding)}`;
}
// ── Text wrapping ────────────────────────────────────────────────────────────
export function splitWrapTokens(text) {
...
export function splitTokenByDisplayWidth(token, width) {
    let head = "";
    let used = 0;
...
export function truncateDisplayWidth(value, width) {
    const ellipsis = "…";
...
// ── Speech bubble ────────────────────────────────────────────────────────────
export function styleBubbleBorder(text, color, fading) {
    const colored = colorize(text, color);
    return fading ? dim(colored) : colored;
}
export function styleBubbleText(text, fading) {
    return fading ? dim(text) : text;
}
export function renderSpeechBubble(text, fading, color, contentWidth, maxLines) {
...
// ── Locale helpers ───────────────────────────────────────────────────────────
export function inferCompanionLanguage(companion) {
